...
var MailgunMailer = /** @class */ (function () {
    function MailgunMailer(subject, recipients, content) {
        this.data = {
    ...
    MailgunMailer.prototype.formatAddresses = function (recipients) {
        return recipients.map(function (_a) {
            var email = _a.email;
            return email;
        }).join(",");
    };
    MailgunMailer.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, mailgun.messages().send(this.data)];
                    case 1:
                        resp = _a.sent();
