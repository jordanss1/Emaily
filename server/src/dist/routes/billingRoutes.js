...
var stripe = new stripe_1.default(keys_1.default.stripeSecretKey, { apiVersion: "2023-08-16" });
var billingRoutes = function (app) {
    app.post("/api/stripe", requireLogin_1.default, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var charge, user;
